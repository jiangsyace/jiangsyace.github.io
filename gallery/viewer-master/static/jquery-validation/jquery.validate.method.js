...
jQuery.validator.addMethod("username",function(value, element) {
	return this.optional(element) || /^[a-zA-Z0-9_]{2,20}$/.test(value);
...
//联系人姓名验证
jQuery.validator.addMethod("contactsName", function(value, element) {
    return this.optional(element) || /^[a-zA-Z\s\u4e00-\u9fa5]{2,50}$/.test(value);
}, "姓名只能为2-50个汉字");

//公司名验证
jQuery.validator.addMethod("companyName", function(value, element) {
    return this.optional(element) || /^[a-zA-Z0-9\s\u4e00-\u9fa5]{2,50}$/.test(value);
}, "企业名只能为2-50个汉字、英文或数字");

//纳税识别号验证
jQuery.validator.addMethod("ratepayingNo", function(value, element) {
